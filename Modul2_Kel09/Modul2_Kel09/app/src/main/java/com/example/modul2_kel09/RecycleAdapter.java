    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, @SuppressLint("RecyclerView") int i) {
        ...
        viewHolder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ParcelAccount pass = new ParcelAccount();
                pass.setAvatar(dataUser.get(i).getAvatar());

                Intent intent = new Intent(mContext, DetailActivity.class);
                intent.putExtra(DetailActivity.EXTRA_ACCOUNT, pass);
                intent.putExtra("name", dataUser.get(i).getFirstName());
                intent.putExtra("name2", dataUser.get(i).getLastName());
